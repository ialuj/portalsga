		...
		<div class="item active">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide1.jpg">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Sistema de Gestão Autárquica (SGA)','appointment'); ?></h2></div>
				<div class="slide-text-bg2"><span><?php _e('O SGA é um Sistema de Gestão Autárquica responsável pela gestão financeira, urbanística, ambiental e serviços municipais.','appointment'); ?></span></div>	
			</div>
		</div>  
		<div class="item">
		   <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide2.jpg">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Sistema de Gestão Autárquica (SGA)','appointment'); ?></h2></div>		
			    <div class="slide-text-bg2"><span><?php _e('O SGA tende a melhorar a produtividade através da agilização de procedimentos, buscando permanentemente a melhoria da qualidade da informação na gestão das Autarquias.','appointment'); ?></span></div>	
			</div>
		</div>
		<div class="item">
		  <img src="<?php echo WEBRITI_TEMPLATE_DIR_URI; ?>/images/slide/slide3.jpg">
			<div class="container slide-caption">
				<div class="slide-text-bg1"><h2><?php _e('Sistema de Gestão Autárquica (SGA)','appointment'); ?></h2></div>
                <div class="slide-text-bg2"><span><?php _e('Actualmente o SGA opera nas Autarquias de Cidade de Maputo • Cidade da Matola • Vila de Boane','appointment'); ?></span></div>	
			<div class="slide-btn-area-sm"><a href="http://sga.rsig.gov.mz/autarquias/" class="slide-btn-sm"><?php _e('Ler mais','appointment'); ?></a></div>
			</div>	
		</div>
		</div>  
