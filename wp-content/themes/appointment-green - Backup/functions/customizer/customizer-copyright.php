...
// Footer copyright section 
	...
	$wp_customize->add_panel( 'appointment_copyright_setting', array(
		...
		'title'      => __('Footer copyright settings', 'appointment-green'),
	) );
    ...
    array(
        'default' => '<p>'.__( '<a href="https://wordpress.org">Proudly powered by WordPress</a> | Theme: <a href="https://webriti.com" rel="designer">Appointment Green</a> by Webriti', 'appointment-green' ).'</p>',
...
$wp_customize->add_control(
    'appointment_options[footer_copyright_text]',
    array(
        'label' => __('Copyright text','appointment-green'),
...
$wp_customize->add_control(
    ...
    array(
        'type' => 'checkbox',
        'label' => __('Hide copyright text','appointment-green'),
        'section' => 'copyright_section_one',
    )
);
	...
	$wp_customize->add_section(
        ...
        array(
            'title' => __('Social Links','appointment-green'),
           'priority' => 45,
			'panel' => 'appointment_copyright_setting',
        )
    );
    ...
    'appointment_options[footer_social_media_enabled]',
    array(
        'label' => __('Hide footer social icons','appointment-green'),
    ...
    'appointment_options[footer_social_media_facebook_link]',
    array(
        'label' => __('Facebook URL','appointment-green'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    array(
        'type' => 'checkbox',
        'label' => __('Open link in new tab','appointment-green'),
        'section' => 'copyright_social_icon',
    )
);
    ...
    'appointment_options[footer_social_media_twitter_link]',
    array(
        'label' => __('Twitter URL','appointment-green'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    'appointment_options[footer_social_media_linkedin_link]',
    array(
        'label' => __('LinkedIn URL','appointment-green'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
    ...
    'appointment_options[footer_social_media_googleplus_link]',
    array(
        'label' => __('GooglePlus URL','appointment-green'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
   ...
   'appointment_options[footer_social_media_skype_link]',
    array(
        'label' => __('Skype URL','appointment-green'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
